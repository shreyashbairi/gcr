...
(function () {
  ...
  function initServiceSidebar() {
    ...
    var services = _sidebarIsRu ? [
      { href: 'service-01.html', label: 'Стратегия выхода на рынок и GTM' },
      { href: 'service-02.html', label: 'Команды развёртывания' },
      { href: 'service-03.html', label: 'Стратегические партнёры' },
      { href: 'service-04.html', label: 'Доступ к капиталу' },
      { href: 'service-05.html', label: 'Управление переговорами' },
      { href: 'service-06.html', label: 'Корпоративное структурирование' },
      { href: 'service-07.html', label: 'Промышленное присутствие' },
      { href: 'service-08.html', label: 'Доступ на рынок' },
      { href: 'service-09.html', label: 'Слияния и поглощения' },
      { href: 'service-10.html', label: 'Цифровые экосистемы' },
      { href: 'service-11.html', label: 'Корпоративное управление' },
      { href: 'service-12.html', label: 'Урегулирование споров' }
    ] : _sidebarIsZh ? [
      { href: 'service-01.html', label: '市场进入与推广策略' },
      { href: 'service-02.html', label: '本地运营基础设施' },
      { href: 'service-03.html', label: '战略合作伙伴搜寻' },
      { href: 'service-04.html', label: '资本对接与全球扩张' },
      { href: 'service-05.html', label: '谈判掌控与渠道效能' },
      { href: 'service-06.html', label: '公司架构与财税治理' },
      { href: 'service-07.html', label: '产业落地与供应链' },
      { href: 'service-08.html', label: '市场准入与合规管理' },
      { href: 'service-09.html', label: '并购全周期与资本配置' },
      { href: 'service-10.html', label: '数字生态与创新对接' },
      { href: 'service-11.html', label: '公司治理与合规操守' },
      { href: 'service-12.html', label: '争议解决与危机应对' }
    ] : [
      { href: 'service-01.html', label: 'Market Entry & GTM' },
      { href: 'service-02.html', label: 'Deployment Teams' },
      { href: 'service-03.html', label: 'Strategic Partners' },
      { href: 'service-04.html', label: 'Capital Access' },
      { href: 'service-05.html', label: 'Negotiation & Channels' },
      { href: 'service-06.html', label: 'Corporate Structuring' },
      { href: 'service-07.html', label: 'Industrial Footprint' },
      { href: 'service-08.html', label: 'Market Access' },
      { href: 'service-09.html', label: 'M&A Lifecycle' },
      { href: 'service-10.html', label: 'Digital Ecosystems' },
      { href: 'service-11.html', label: 'Corporate Governance' },
