...
(function () {
  ...
  function initMobileMenu() {
    ...
    var menuEN = [
      ...
      '    <a href="about-gcr.html" class="mobile-drawer__link">About GCR</a>',
    ...
    var menuZH = [
      ...
      '    <a href="about-gcr.html" class="mobile-drawer__link">关于 GCR</a>',
      '    <div class="mobile-drawer__group">',
      '      <button class="mobile-drawer__group-btn" aria-expanded="false">',
      '        服务',
      '        <svg class="mobile-drawer__chevron" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 1l4 4 4-4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
      '      </button>',
      '      <div class="mobile-drawer__sub" aria-hidden="true">',
      '        <a href="market-entry-gtm.html">市场进入与推广策略</a>',
      '        <a href="deployment-teams.html">本地运营基础设施</a>',
      '        <a href="strategic-partner-search.html">战略合作伙伴搜寻</a>',
      '        <a href="capital-access.html">资本对接与全球扩张</a>',
      '        <a href="negotiation-mastery.html">谈判掌控与渠道效能</a>',
      '        <a href="corporate-structuring.html">公司架构与财税治理</a>',
      '        <a href="industrial-footprint.html">产业落地与供应链</a>',
      '        <a href="market-access-compliance.html">市场准入与合规管理</a>',
      '        <a href="mna-lifecycle.html">并购全周期与资本配置</a>',
      '        <a href="digital-ecosystems.html">数字生态与创新对接</a>',
      '        <a href="corporate-governance.html">公司治理与合规操守</a>',
    ...
    var menuRU = [
      ...
      '    <a href="about-gcr.html" class="mobile-drawer__link">О ВКР</a>',
      '    <div class="mobile-drawer__group">',
      '      <button class="mobile-drawer__group-btn" aria-expanded="false">',
      '        Услуги',
      '        <svg class="mobile-drawer__chevron" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 1l4 4 4-4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
      ...
      '        <a href="industrial-footprint.html">Промышленное присутствие</a>',
      '        <a href="market-access-compliance.html">Доступ на рынок</a>',
      '        <a href="mna-lifecycle.html">Слияния и поглощения</a>',
      '        <a href="digital-ecosystems.html">Цифровые экосистемы</a>',
      '        <a href="corporate-governance.html">Корпоративное управление</a>',
    ...
    drawer.innerHTML = [
      ...
      '    <a href="contact-us.html" class="mobile-drawer__cta">' + ctaText + '</a>',
      '  </div>',
      '</div>'
    ]).join('\n');
  ...
  function initServiceSidebar() {
    ...
    var services = _sidebarIsRu ? [
      { href: 'market-entry-gtm.html', label: 'Стратегия выхода на рынок и GTM' },
      { href: 'deployment-teams.html', label: 'Команды развёртывания' },
      { href: 'strategic-partner-search.html', label: 'Стратегические партнёры' },
      { href: 'capital-access.html', label: 'Доступ к капиталу' },
      { href: 'negotiation-mastery.html', label: 'Управление переговорами' },
      { href: 'corporate-structuring.html', label: 'Корпоративное структурирование' },
      { href: 'industrial-footprint.html', label: 'Промышленное присутствие' },
      { href: 'market-access-compliance.html', label: 'Доступ на рынок' },
      { href: 'mna-lifecycle.html', label: 'Слияния и поглощения' },
      { href: 'digital-ecosystems.html', label: 'Цифровые экосистемы' },
      { href: 'corporate-governance.html', label: 'Корпоративное управление' },
      { href: 'legal-defense-crisis.html', label: 'Урегулирование споров' }
    ] : _sidebarIsZh ? [
      { href: 'market-entry-gtm.html', label: '市场进入与推广策略' },
      { href: 'deployment-teams.html', label: '本地运营基础设施' },
      { href: 'strategic-partner-search.html', label: '战略合作伙伴搜寻' },
      { href: 'capital-access.html', label: '资本对接与全球扩张' },
      { href: 'negotiation-mastery.html', label: '谈判掌控与渠道效能' },
      { href: 'corporate-structuring.html', label: '公司架构与财税治理' },
      { href: 'industrial-footprint.html', label: '产业落地与供应链' },
      { href: 'market-access-compliance.html', label: '市场准入与合规管理' },
      { href: 'mna-lifecycle.html', label: '并购全周期与资本配置' },
      { href: 'digital-ecosystems.html', label: '数字生态与创新对接' },
      { href: 'corporate-governance.html', label: '公司治理与合规操守' },
      { href: 'legal-defense-crisis.html', label: '争议解决与危机应对' }
    ] : [
      { href: 'market-entry-gtm.html', label: 'Market Entry & GTM' },
      { href: 'deployment-teams.html', label: 'Deployment Teams' },
      { href: 'strategic-partner-search.html', label: 'Strategic Partners' },
      { href: 'capital-access.html', label: 'Capital Access' },
      { href: 'negotiation-mastery.html', label: 'Negotiation & Channels' },
      { href: 'corporate-structuring.html', label: 'Corporate Structuring' },
      { href: 'industrial-footprint.html', label: 'Industrial Footprint' },
      { href: 'market-access-compliance.html', label: 'Market Access' },
      { href: 'mna-lifecycle.html', label: 'M&A Lifecycle' },
      { href: 'digital-ecosystems.html', label: 'Digital Ecosystems' },
      { href: 'corporate-governance.html', label: 'Corporate Governance' },
      { href: 'legal-defense-crisis.html', label: 'Legal Defense & Crisis' }
    ];
